<?php
	...
	$sql = "select * from content where theloaiID=".$rs1["theloaiID"]." limit 3";
	$rs2 = select_list($sql);
	
	$sql = "select * from content where theloaiID=".$rs1["theloaiID"]." order by luotxem desc limit 3";
	$rs3 = select_list($sql);
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link type="text/css" href="Cuthe.css" rel="stylesheet" media="screen"/>
		...
		<div class ="wrapper1">
			 <div class="wrapper2">
				...
				<div class="content">
					 ...
					 <div class="content1 space-bottom1">
						<div class="content1-title">
							 <h1>
								 <?php echo $rs1["title"];?>
							 </h1>
							 <p class="time">
								 <?php echo $rs1["thoigiandang"];?>
							 </p>
							 <p class="title"> 
