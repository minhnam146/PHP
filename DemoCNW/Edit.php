				...
				<h1>Sửa tin bài</h1>
					...
					<form class="form" action="Edit_exec.php" method="post"  enctype="multipart/form-data">
						...
						<?php foreach ($cates as $cat) {?>						
							<option value="<?php echo $cat["ID"]?>" <?php if ($cat["ID"] == $result["theloaiID"]){?>selected<?php } ?>><?php echo $cat["Name"]?></option>
						<?php } ?>
						</select>
						...
						<label>Image:</label>
						<div class="clear-both"></div>
						<input type="file" name="img" value="<?php echo $result["img"]?>"/>
						<div class="clear-both"></div>
						...
						<div class="clear-both"></div>
						<input name="Trongnuoc" value="<?php echo $result["Trongnuoc"]?>"/>
						<div class="clear-both"></div>
						<label>Ngoài Nước:</label>
						<div class="clear-both"></div>
						<input name="Ngoainuoc" value="<?php echo $result["Ngoainuoc"]?>"/>
						<div class="clear-both"></div>
						<button class="space-bottom1">OK:</button>
					</form>
					<br/>
					<br/>
					<div class="clear-both"></div>
